  ...
  <div class="flex justify-center w-full flex-wrap">
      <nav class="px-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 w-full">
        <div class="flex flex-wrap justify-between items-center mx-auto bg-white">
          ...
          <div class="hidden w-full md:block md:w-auto bg-white" id="mobile-menu">
            <ul class="flex flex-col p-4 mt-4 bg-white rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
              ...
              <li>
                  ...
                  <!-- Dropdown menu -->
                  <div id="dropdownNavbar" class="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 310px);" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom">
