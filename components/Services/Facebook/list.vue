...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      search() {
        this.$store.dispatch('facebook/init', {search: this.searchStr});
      },

      handleCurrentChange(val) {
        this.$store.dispatch('facebook/init', {page: val});
      },

      getPeriodType() {
        this.$store.dispatch('facebook/getPeriodType');
      },

      getExpiredType() {
        this.$store.dispatch('facebook/getExpiredType');
      },
      ...
      async detail(id) {
        var data = await this.$store.dispatch("facebook/getDetail", id);
      ...
      async update() {
        try {
          await this.$store.dispatch('facebook/update', { id: this.selectedItem._id, data: this.selectedItem });
          this.$message({
      ...
      async remove(id) {
        try {
          this.$confirm('Bạn có muốn xóa dịch vụ này không?', 'Xóa dịch vụ', {
            ...
            await this.$store.dispatch('facebook/delete', id);
            this.$message({
                type: 'success',
    ...
    computed: {
      ...
      countAll() {
        return this.$store.state.facebook.countAll;
      },

      countPeriod() {
        return this.$store.state.facebook.countPeriod;
      },

      countExpired() {
        return this.$store.state.facebook.countExpired;
      }, 
    },
